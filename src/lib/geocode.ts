...
const TR_BBOX = '25.6,35.8,44.9,42.2' // minLon,minLat,maxLon,maxLat
...
/** Açık adres / semt / mahalle araması (Photon + Open-Meteo yedek). */
...
/** Koordinattan okunabilir adres üretir. */
...
/** Türkiye sınırlarına yakınlık + geçerli koordinat kontrolü. */
...
export const DEFAULT_MAP_CENTER = { lat: 41.0082, lng: 28.9784 } // İstanbul

/** Leaflet harita seçici HTML (web iframe / mobil WebView). */
